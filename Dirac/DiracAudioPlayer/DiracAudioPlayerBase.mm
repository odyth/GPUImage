...
{    
	...
	long totalFramesPlayed = (long)Self.mTotalFramesPlayed;		// store this in a temporary to avoid ObjC call overhead
	long totalFramesGenerated = (long)Self.mTotalFramesGenerated;		// store this in a temporary to avoid ObjC call overhead
